## вы заебали эту хуету форкать уже.
## давайте так, кто форкнет этот "репозиторий"(его трудно так назвать) у того мама умерла, и чей отец сьебал в тайланд по обьявлению чтобы работать проституткой с 30 неграми. дальше уже по индивидуальному случаю, если во время половых утех у отца выпал пенис или воовсе он погиб то вы безотцовшина ебанная
## это относится и к тем кто успел форкнуть проект до этого сообщения
## спите спокойно, выблядки
