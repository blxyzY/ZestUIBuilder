...
# Vendor overlays
mount -o bind /system/axisgsi/vo /vendor/overlay || true
mount -o bind /system/axisgsi/group /vendor/etc/group || true
mount -o bind /system/axisgsi/passwd /vendor/etc/passwd || true
